...
<div id='hdr'>
<h1><a href='' title='<?php echo $config["forumTitle"];?>'><img src='<?php echo !empty($config["forumLogo"])?$config["forumLogo"]:"skins/{$config["skin"]}/logo.svg";?>' alt=''/> <span id='forumTitle'><?php echo $config["forumTitle"];?></span></a></h1>
