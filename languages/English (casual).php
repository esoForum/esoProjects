...
"Donate to esoForum" => "Donate to esoForum",
"edit" => "edit",
"edited by" => "edited by",
"Email" => "Email",
...
"fatalErrorMessage" => "<p>esoProjects has encountered an nasty error which is making it impossible to do whatever it is that you're doing. But don't feel down - <strong>here are a few things you can try</strong>:</p>
<ul>
<li>Go outside, walk the dog, have a coffee... then <strong><a href='javascript:window.location.reload()'>try again</a></strong>!</li>
<li>If you are the forum administrator, then you can <strong>get help on <a href='https://esotalk.net'>esoForum</a></strong>.</li>
...
"downloadPlugins" => array("class" => "info", "message" => "You can download more plugins from the <a href='https://github.com/esoforum'>esoForum repo</a>."),
"downloadSkins" => array("class" => "info", "message" => "You can download more skins from the <a href='https://github.com/esoforum'>esoForum repo</a>."),
...
"updatesAvailable" => array("class" => "info", "message" => "A new version of esoProjects (<strong>%s</strong>) is available for download. You have version {$versions["esoTalk"]}. <strong><a href='https://github.com/esoforum'>Get it now</a></strong>!"),
