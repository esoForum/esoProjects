...
?>');
	...
	if ($config["useModRewrite"]) {
		writeFile("../.htaccess", "# Generated by esoProjects
...
function fatalChecks()
{
	...
	if (count($fileErrors)) $errors[] = "esoProjects cannot write to the following files/folders: <strong>" . implode("</strong>, <strong>", $fileErrors) . "</strong>.<br/><small>To resolve this, you must navigate to these files/folders in your FTP client and <strong>chmod</strong> them to <strong>777</strong>.</small>";
