...
$queries[] = "CREATE TABLE {$config["tablePrefix"]}members (
	...
	emailOnPrivateAdd tinyint(1) NOT NULL default '0',
	emailOnStar tinyint(1) NOT NULL default '0',
...
(2, 'How to use esoProjects', '" . slug("How to use esoProjects") . "', 1, 1, 1, $time, $time, 0),
